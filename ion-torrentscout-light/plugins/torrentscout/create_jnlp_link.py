...
fn_html = options.results_dir + '/torrentscout.html'
...
fhtml.write('      break;    \n')
fhtml.write('	case "4":\n')
fhtml.write('      openMasterLaunch(\'2048m\', \'3000m\');\n')
fhtml.write('      break;    \n')
fhtml.write('	case "5":\n')
fhtml.write('      openMasterLaunch(\'2048m\', \'4096m\');\n')
fhtml.write('      break;    \n')
fhtml.write('	case "6":\n')
fhtml.write('      openMasterLaunch(\'3000m\', \'5500m\');\n')
fhtml.write('      break;\n')
fhtml.write('	case "7":\n')
fhtml.write('      openMasterLaunch(\'4096m\', \'6500m\');\n')
fhtml.write('      break;\n')
fhtml.write('    }\n')
fhtml.write('  }\n')
fhtml.write('</script>\n')
...
fhtml.write('<option value="4">3 GB memory (Java 64 bit) (316 chips) </option>\n')
fhtml.write('<option value="5">4 GB memory (Java 64 bit) (316 chips) </option>\n')
fhtml.write('<option value="6">5 GB memory (Java 64 bit) (318+ chips) </option>\n')
fhtml.write('<option value="7">6 GB memory (Java 64 bit) (318+ chips) </option>\n')
...
fhtml.write('<hr>\n')
fhtml.write('<font size=2><i>Please go to the <a href="https://github.com/iontorrent/TorrentScout">GitHub</a> or the <a href="https://iontorrent.jira.com/wiki/display/TSC/Home">Ion Torrent</a> Torrent Scout page for documentation and source,')
