 ...
 */
public class FileContainer implements Container.Hierarchical {
     ...
     *            are ignored.
     */
    public FileContainer(File root, int levels) {
        this.levels = levels;
        if (root != null) {
            roots = new File[] { root };
        }
     ...
     */
    public FileContainer(File root, boolean recursive, int levels) {
        this(root, levels);
     ...
     *            should the container recursively contain subdirectories.
     */
    public FileContainer(File root, String extension, boolean recursive) {
        this(root, 3);
     ...
     *            should the container recursively contain subdirectories.
     */
    public FileContainer(File root, FilenameFilter filter,
            boolean recursive) {
        this(root, 3);
     ...
     */
    private void addItemIds(Collection<File> col, File f, int curlevel) {
    ...
    public class FileItem implements Item {
        ...
        @Override
        public int hashCode() {
            return file.hashCode() ^ FileContainer.this.hashCode();
        }
         ...
         */
        private FileContainer getHost() {
            return FileContainer.this;
        }
    ...
    private static void err(String msg, Exception ex) {
        Logger.getLogger(FileContainer.class.getName()).log(Level.SEVERE, msg, ex);
    }
    
    private static void err(String msg) {
        Logger.getLogger(FileContainer.class.getName()).log(Level.SEVERE, msg);
    }
    
    private static void warn(String msg) {
        Logger.getLogger(FileContainer.class.getName()).log(Level.WARNING, msg);
    }
    
    private static void p(String msg) {
        ////system.out.println("FileContainer: " + msg);
        Logger.getLogger(FileContainer.class.getName()).log(Level.INFO, msg);
    }
}
