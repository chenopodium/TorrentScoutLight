...
public class FrameWidget extends Polygon {

	
	
	public FrameWidget(int x, int y, int width, int height) {
		this(x, y, width, height, java.awt.Color.RED, 1);
	}
	
	public FrameWidget(int x, int y, int width, int height, java.awt.Color col, int nr) {
		super(null);
		this.setLocky(true);
		int s = 2;
		int m = height/2;
	...
	private static void p(String msg) {
		System.out.println("FrameWidget: " + msg);
		Logger.getLogger(FrameWidget.class.getName()).log(Level.INFO, msg);
	}
}
